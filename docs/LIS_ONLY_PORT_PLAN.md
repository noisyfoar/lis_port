...
Цель: поведенческая совместимость с upstream `dlisio` в LIS-части.
...
- совместимые значения curves (по каналам, типам и форме результата).
